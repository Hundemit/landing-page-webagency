      ...
      <footer id="footer" className="relative mx-auto flex max-w-6xl flex-wrap pt-4">
        ...
        <div className="mr-auto flex w-full justify-between lg:w-fit lg:flex-col">
          <Link className="flex items-center gap-1 text-2xl font-bold tracking-tight" href={siteConfig.baseLinks.home} aria-label="Home">
            <span className="sr-only">Nordi Logo</span>
          ...
          <div>
            <div className="mt-4 flex items-center">
              {/* Social Icons */}
              <Link href="#" target="_blank" rel="noopener noreferrer" className="rounded-sm p-2 text-gray-700 transition-colors duration-200 hover:bg-gray-200 hover:text-gray-900">
            ...
            <div className="ml-2 hidden text-sm text-gray-700 lg:inline">&copy; {CURRENT_YEAR} Solar Technologies, Inc.</div>
          </div>
        </div>
