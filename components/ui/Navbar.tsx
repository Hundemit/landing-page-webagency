...
export function NavBar() {
  ...
  return (
    <header
      className={cn(
        "fixed inset-x-3 top-0   z-50 mx-auto backdrop-blur-sm flex max-w-6xl transform-gpu animate-slide-down-fade justify-center overflow-hidden rounded-xl border border-transparent px-3 py-3 transition-all duration-300 ease-[cubic-bezier(0.16,1,0.3,1.03)] will-change-transform",
        open === true ? "h-52" : "h-16",
