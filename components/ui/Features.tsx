import { RiCarFill, RiCheckLine, RiCircleLine, RiCodepenLine, RiContrast2Line, RiFullscreenFill, RiLoaderFill, RiNotification2Line, RiPlaneFill, RiTruckFill } from "@remixicon/react";
...
export default function Features() {
  return (
    <section aria-label="Solar Technologies Features for Farms" id="solutions" className="relative mx-auto max-w-6xl scroll-my-24">
      {/* Vertical Lines */}
      ...
      <div className="grid grid-cols-1 gap-12 md:grid-cols-4 md:gap-0">
        ...
        <div className="col-span-2 my-auto px-2">
          ...
          <p className="mt-2 text-3xl font-semibold tracking-tighter text-balance text-gray-900 md:text-4xl">A network of autonomous systems for complete farm monitoring</p>
            ...
            <defs>
              <pattern id="diagonal-feature-pattern" patternUnits="userSpaceOnUse" width="64" height="64">
                {Array.from({ length: 17 }, (_, i) => {
                  const offset = i * 8;
                  return <path key={i} d={`M${-106 + offset} 110L${22 + offset} -18`} className="stroke-gray-200/70" strokeWidth="1" />;
                })}
              </pattern>
            </defs>
                  ...
                  <div key="obj1" className="relative flex items-center justify-center">
                    ...
                    <div className="absolute -top-5 left-4">
                      <div className="flex gap-1">
                        ...
                        <div className="rounded-r-full bg-white/50 py-0.5 pr-1.5 pl-1 text-xs whitespace-nowrap ring-1 ring-gray-200">Drivetrain Error</div>
                      </div>
                    </div>
                    <div
                      style={{
                  ...
                  <div key="obj2" className="relative flex items-center justify-center">
                    ...
                    <div className="absolute -top-5 left-4">
                      <div className="flex gap-1">
                        ...
                        <div className="rounded-r-full bg-white/50 py-0.5 pr-1.5 pl-1 text-xs ring-1 ring-gray-200">Charging</div>
                      </div>
                    </div>
                    <div
                      style={{
                  ...
                  <div key="obj4" className="relative flex items-center justify-center">
                    ...
                    <div className="absolute -top-5 left-4">
                      <div className="flex gap-1">
                        ...
                        <div className="rounded-r-full bg-white/50 py-0.5 pr-1.5 pl-1 text-xs ring-1 ring-gray-200">Farming</div>
                      </div>
                    </div>
        ...
        <div className="col-span-2 my-auto px-2">
          ...
          <p className="mt-2 text-3xl font-semibold tracking-tighter text-balance text-gray-900 md:text-4xl">Scale your smart farm with plug-and-play simplicity</p>
          <p className="mt-4 text-balance text-gray-700">
